...
let firstName = new String("Rishi");
...
console.log(firstName.includes("Ris"));
console.log(firstName.startsWith("Ris"));
console.log(firstName.endsWith("Ris"));
console.log(firstName[0]);
let anotherName = firstName.replace("Rishi", "Mr") + "i";
...
let course = courses.find(function(course) {
    return course.NAme === "BSA";
});

console.log(course);

course = courses.find(function(course) {
    return course.NAme === "DEVOPS";
});

console.log(course);

course = courses.find(course => course.NAme === "DSA");
console.log(course);
