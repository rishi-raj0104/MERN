...
exports.videoUpload = async (req, res) => {
    try {
        ...
        const response = await uploadFileToCloudinary(videoFile, "fileupload");
...
exports.imageReducer = async (req, res) => {
    try {
        ...
        const response = await uploadFileToCloudinary(imageFile, "fileupload", 50);
        console.log(response)
